...
import { formatPrice, useFavorites, useToast } from "../context";
        ...
        >
          ...
          >
            ...
            <div className="safe-top absolute left-3 right-3 top-7 z-10 flex items-center gap-2">
              <img src={story.avatar} className="h-8 w-8 rounded-full object-cover ring-2 ring-white/60" />
  ...
  return (
    ...
    >
      ...
      <div className="space-y-1.5 p-3">
        <p className="text-heading truncate text-[15px] text-ink-900">{formatPrice(property.price, property.currency, property.dealType)}</p>
  ...
  return (
    <div className="flex items-center gap-3 rounded-[var(--radius-lg)] border border-border bg-white p-4">
      ...
      <div className="min-w-0 flex-1">
        ...
        <div className="mt-0.5 flex items-center gap-1 text-[12.5px] font-semibold text-vip-dark">
          ⭐ {seller.rating}
        </div>
      </div>
      <div className="flex flex-col gap-2">
        <motion.button
          whileTap={{ scale: 0.9 }}
          onClick={() => showToast("Qo'ng'iroq qilinmoqda...", "info")}
